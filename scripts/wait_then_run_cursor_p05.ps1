...
$p04Complete = Join-Path $batchDir "cursor-p04-knowledge-v002$waveSuffix-complete.json"
$statusPath = Join-Path $batchDir "cursor-p05-knowledge-v002$waveSuffix-status.jsonl"
$failurePath = Join-Path $batchDir "cursor-p05-knowledge-v002$waveSuffix-failures.jsonl"
...
@{
    ...
    Join-Path $batchDir "cursor-p05-knowledge-v002$waveSuffix-complete.json"
)
