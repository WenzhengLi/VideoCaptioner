# P01 Normalize v003 — 完整保留前提下的实际规范化
...
python -m course_video_analyzer.knowledge.cli normalize-p01 <course_id> <input> <output> `
  --prompt-version knowledge-v003-p01
```
...
和 segment ID 必须保持不变。将最终 `prompt_version` 写为 `knowledge-v003-p01`，并增加：
...
{
  "schema_version": "1.0",
  "prompt_version": "knowledge-v003-p01",
  "source_ids": ["C001"],
  "segments": [{
