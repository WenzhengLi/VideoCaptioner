...
> 五课状态：8 案例中 7 个发布、1 个人工复核、0 程序失败
...
当前进入五课人工抽检和 15 课扩展决策阶段。

## 五、当前立即动作

1. 对五课 8 案例做人工忠实度抽检，重点检查 C007 speaker 不确定性和 C012 高未分配率；
2. 保持 C006/CASE-C006-001 为人工复核，不强行发布；
3. 根据抽检结果决定是否冻结 `mimo-method-v002`；
4. 冻结后扩展到 15 课，再扩展到 20 课；
5. 使用 `data/dify/afeng-release-v002.2/` 做离线发布验收；
