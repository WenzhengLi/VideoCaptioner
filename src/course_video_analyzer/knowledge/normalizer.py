...
DEFAULT_DISFLUENCY_RULES: tuple[tuple[str, str, str], ...] = (
    ...
    (r"(?:因为){2,}", "因为", "disfluency_normalized"),
    (r"(?:大家){2,}", "大家", "disfluency_normalized"),
    (r"洗洗完", "洗完", "disfluency_normalized"),
    (r"熊熊猫", "熊猫", "disfluency_normalized"),
    (r"家家里", "家里", "disfluency_normalized"),
    (r"你你们", "你们", "disfluency_normalized"),
    (r"今今年", "今年", "disfluency_normalized"),
    (r"今今天", "今天", "disfluency_normalized"),
    (r"昨昨+晚", "昨晚", "disfluency_normalized"),
    (r"第第+一次", "第一次", "disfluency_normalized"),
    (r"跟跟+", "跟", "disfluency_normalized"),
    (r"约约+", "约", "disfluency_normalized"),
    (r"在在+", "在", "disfluency_normalized"),
